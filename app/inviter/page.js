...
function InviterPage() {
  ...
  const shareText = "Hej! Jeg synes du skal tjekke Konsulentbud.dk ud. Det er en dansk platform, hvor man nemt kan få hjælp til konsulentopgaver, eller byde på opgaver og tjene penge.";
  ...
  async function nativeShare() {
    try {
      await navigator.share({ title: "Konsulentbud", text: fullMessage });
    } catch (e) {
  ...
  return (
    <div style={{ marginTop: 24, maxWidth: 560, marginBottom: 60 }}>
      ...
      <p style={{ color: "#5B6478", fontSize: 14, marginBottom: 24 }}>Del dit personlige link, så andre nemt kan finde vej til Konsulentbud.</p>
