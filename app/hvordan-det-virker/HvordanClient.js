...
export default function HowItWorksClient() {
  ...
  return (
    <div style={{ marginTop: 24, marginBottom: 60 }}>
      <div
        style={{
          background: "linear-gradient(180deg, #F3EEFC 0%, #fff 100%)",
          borderRadius: 28,
          padding: "44px 40px",
          marginBottom: 36,
          textAlign: "center",
      ...
      >
        <h1 style={{ fontSize: 30, fontWeight: 800, marginBottom: 12 }}>Sådan fungerer Konsulentbud</h1>
      ...
      <div style={{ textAlign: "center" }}>
        ...
        <Link
          href="/opgaver"
          style={{ display: "inline-block", fontSize: 14.5, fontWeight: 700, padding: "13px 26px", borderRadius: 12, border: "1.5px solid #E4E8F0", color: "#241C35" }}
        >
          Se åbne opgaver
        </Link>
      </div>
