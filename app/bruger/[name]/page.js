...
export async function generateMetadata({ params }) {
  ...
  try {
    ...
    const description = profile?.bio
      ...
      : `Se ${name}s profil, anmeldelser og bud på Konsulentbud.`;
    return {
      title: `${name} - Konsulentbud`,
      description,
      alternates: { canonical: `https://konsulentbud.dk/bruger/${encodeURIComponent(name)}` },
    ...
    return { title: `${name} - Konsulentbud`, robots: { index: false, follow: true } };
  }
}
