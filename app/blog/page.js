...
export const metadata = {
  title: "Blog - Konsulentbud",
  description: "Gode råd og praktisk viden om strategi, IT, økonomi, HR, marketing og andre konsulentopgaver.",
  alternates: { canonical: "https://konsulentbud.dk/blog" },
};
  ...
  return (
    <div style={{ marginTop: 24, marginBottom: 60 }}>
      ...
      <p style={{ fontSize: 14.5, color: "#5B6478", marginBottom: 32, maxWidth: 600 }}>
        Gode råd og praktisk viden om bogføring, kundeservice, oversættelse, AI og de andre opgavetyper, I finder på Konsulentbud.
      </p>
