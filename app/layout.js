...
export const metadata = {
  metadataBase: new URL("https://konsulentbud.dk"),
  title: {
    default: "Konsulentbud - Byd ind på konsulentopgaver",
    template: "%s",
  },
  description: "Opret konsulentopgaver og modtag bud fra kvalificerede konsulenter.",
  openGraph: {
    ...
    "@graph": [
      {
        ...
        logo: "https://konsulentbud.dk/icon-512.png",
      },
      {
        "@type": "WebSite",
        name: "Konsulentbud",
