  ...
  return (
    <div style={{ marginTop: 24, maxWidth: 560, marginBottom: 60 }}>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 4 }}>
        ...
        <h2 style={{ fontSize: 22, fontWeight: 800 }}>Konsulentbud support</h2>
      </div>
      <p style={{ color: "#5B6478", fontSize: 14, marginBottom: 20 }}>
        Beskeder fra Konsulentbuds supportteam om din konto eller dine opgaver - og dine egne svar til dem.
      </p>
