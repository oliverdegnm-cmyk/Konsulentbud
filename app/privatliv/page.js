export const metadata = {
  title: "Privatlivspolitik - Konsulentbud",
  description: "Sådan behandler Konsulentbud dine personoplysninger.",
  alternates: { canonical: "https://konsulentbud.dk/privatliv" },
};
    ...
    <div style={{ marginTop: 24, marginBottom: 60, maxWidth: 720 }}>
      ...
      <Section title="4. Videregivelse af oplysninger til tredjeparter">
        ...
        <ul style={{ marginTop: 8, paddingLeft: 20 }}>
          <li><b>Stripe</b> - behandler betalinger og udbetalinger. Stripe modtager de oplysninger, der er nødvendige for at gennemføre en betaling, herunder betalingskortoplysninger, som Konsulentbud ikke selv har adgang til.</li>
