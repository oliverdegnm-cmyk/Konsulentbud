...
// Beskeder mellem en bruger og Konsulentbud support - genbruger "messages"-tabellen,
...
export async function POST(request) {
  try {
    ...
    // "Konsulentbud support", uanset hvilken admin der faktisk skriver - så fremstår
    ...
    if (admin) {
      await notify(recipient, "admin_message", null, `Besked fra Konsulentbud support: ${text?.trim() || "Se vedhæftning"}`, origin);
    } else {
