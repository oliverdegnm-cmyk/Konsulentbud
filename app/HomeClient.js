...
// "konsulentopgaver" er sat ind som hvert femte ord, så platformens eget navn
...
export default function HomePage() {
  ...
  const heroWordIsKontor = heroWord === "konsulentopgaver";
    ...
    <div>
          ...
          {heroLoaded &&
            heroImages.map((img, i) => (
              <Image
                key={img.url + i}
                src={img.url}
                alt="Konsulentbud - få bud på dine konsulentopgaver"
                fill
                priority={i === 0}
      ...
      <div style={{ background: "#F5F7FB", borderRadius: 20, padding: "44px 48px", marginTop: 72 }}>
        ...
        <p style={{ fontSize: 13.5, color: "#5B6478", lineHeight: 1.6, margin: 0, maxWidth: 600 }}>
          Betalingen håndteres af Stripe, der lever op til de højeste standarder for datasikkerhed (PCI DSS niveau 1). Dine kortoplysninger går aldrig gennem Konsulentbuds egne servere, og beløbet frigives først, når du selv godkender.
        </p>
      </div>
