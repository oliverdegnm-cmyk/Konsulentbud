export const metadata = {
  title: "Vilkår og betingelser - Konsulentbud",
  description: "Vilkår og betingelser for brug af Konsulentbud.",
  alternates: { canonical: "https://konsulentbud.dk/vilkaar" },
};
...
export default function TermsPage() {
  return (
    <div style={{ marginTop: 24, marginBottom: 60, maxWidth: 720 }}>
      ...
      <Section title="1. Om Konsulentbud">
        <p>
          Konsulentbud er en dansk platform, der formidler kontakt mellem brugere, der har behov for hjælp til konsulentopgaver ("Opgavestillere"), og brugere, der tilbyder at udføre sådanne opgaver mod betaling ("Konsulenter"). Platformen drives af [firmanavn / dit fulde navn], [CVR-nummer, hvis relevant], [adresse].
        </p>
      </Section>

      <Section title="2. Definitioner">
        <p>
          "Opgave" betyder en arbejdsopgave oprettet af en Opgavestiller på platformen. "Bud" betyder et tilbud fra en Hjælper om at udføre en Opgave til en angivet pris. "Platformen" betyder hjemmesiden konsulentbud.dk og de tilhørende funktioner.
        </p>
      </Section>
      ...
      <Section title="6. Platformens rolle og ansvarsbegrænsning">
        <p>
          Konsulentbud er alene en formidler af kontakt mellem Opgavestillere og Hjælpere. Aftalen om udførelse af en Opgave indgås direkte mellem disse to parter. Konsulentbud er ikke part i denne aftale og påtager sig intet ansvar for kvaliteten, lovligheden eller udførelsen af en Opgave. Konsulentbud fører ikke kontrol med Hjælperes kvalifikationer ud over det, der fremgår af deres profil og eventuelle anmeldelser.
        </p>
      </Section>

      <Section title="7. Annullering og tvister">
        <p>
          En Opgave kan annulleres, før den er markeret som udført, hvorved en eventuel holdt betaling refunderes til Opgavestilleren. Opstår der uenighed mellem en Opgavestiller og en Hjælper, opfordres parterne til først at søge at løse denne indbyrdes. Konsulentbud kan i særlige tilfælde bistå via kundeservice, men er ikke forpligtet til at afgøre tvister mellem brugere.
        </p>
      </Section>

      <Section title="8. Brugerens forpligtelser">
        <p>
          Du må ikke bruge platformen til ulovlige formål, til at omgå platformens gebyrer ved at aftale betaling uden for platformen for en Opgave oprettet på platformen, eller til at chikanere andre brugere. Konsulentbud forbeholder sig retten til at lukke konti, der overtræder disse vilkår.
        </p>
      </Section>

      <Section title="9. Opsigelse">
        <p>Du kan til enhver tid lukke din konto ved at kontakte kundeservice. Konsulentbud kan opsige eller suspendere en konto ved overtrædelse af disse vilkår.</p>
      </Section>

      <Section title="10. Ændringer af vilkårene">
        <p>Konsulentbud kan opdatere disse vilkår løbende. Væsentlige ændringer vil blive meddelt brugere, f.eks. via email.</p>
      </Section>
