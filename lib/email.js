    ...
    await client.emails.send({
      ...
      html: `
        <div style="font-family:sans-serif; max-width:480px; margin:0 auto;">
          ...
          <a href="${origin}" style="display:inline-block; background:#2A55E5; color:#fff; padding:12px 22px; border-radius:10px; text-decoration:none; font-weight:700; margin:16px 0;">Åbn Konsulentbud</a>
