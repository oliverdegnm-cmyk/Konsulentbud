export const FAQ_SECTIONS = [
  {
    ...
    items: [
      {
        q: "Er det gratis at bruge Konsulentbud?",
        a: "Ja, det er helt gratis at oprette en opgave og modtage forslag. Som opgavestiller betaler du kun den pris, du selv accepterer fra en hjælper. Som hjælper betaler du et gebyr af det, du tjener - se mere under \"Betaling\" nedenfor.",
      },
      {
        q: "Skal jeg oprette en konto for at se opgaver?",
        a: "Nej, du kan browse åbne opgaver og kategorier uden at oprette dig. Du skal først oprette en konto, når du vil oprette en opgave, sende et forslag, eller sende en besked.",
      },
      {
      ...
      {
        q: "Kan jeg både oprette opgaver og sende forslag på opgaver med samme konto?",
      ...
      {
        q: "Kan jeg finde en konsulent uden selv at oprette en opgave og vente på forslag?",
        a: "Ja. Under \"Konsulenter\" kan du gennemse konsulenter, der har udfyldt en profil og markeret, hvilke kategorier de tager opgaver inden for - filtrér efter fagområde, og tag selv kontakt. Vil du hellere modtage flere forslag og sammenligne, er det stadig hurtigst at oprette en opgave.",
      },
    ],
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: "Nej. Du kan angive et vejledende budget, men det er helt op til konsulenterne selv at foreslå den pris, de mener, opgaven er værd - du vælger frit blandt de forslag, du modtager.",
      },
      {
        q: "Kan jeg redigere en opgave, efter jeg har oprettet den?",
        a: "Ja, så længe opgaven stadig er åben og ikke har fået et forslag accepteret. Har du allerede valgt en hjælper, kan opgaven ikke længere redigeres.",
      },
      {
        q: "Skal opgaven løses eksternt, eller kan jeg kræve personligt fremmøde?",
        a: "Begge dele er muligt. Ved oprettelse vælger du \"Eksternt\" eller \"Personligt fremmøde\". Vælger du personligt fremmøde, angiver du en adresse - den vises dog kun til den konsulent, hvis forslag du rent faktisk vælger, ikke offentligt.",
      },
      {
        q: "Kan jeg annullere en opgave?",
        a: "Ja, så længe den ikke er markeret som udført. Har du allerede valgt et forslag og betalt, bliver beløbet automatisk refunderet ved annullering.",
      },
    ],
  },
  {
    title: "Send forslag på en opgave",
    items: [
      {
        q: "Koster det noget at sende et forslag på en opgave?",
        a: "Nej, det er gratis at sende et forslag. Du betaler først et gebyr, hvis dit forslag bliver valgt, og du rent faktisk får udbetalt penge for opgaven.",
      },
      {
        q: "Hvad er niveauer, og hvorfor betyder de noget?",
        a: "Jo flere opgaver du gennemfører, og jo bedre din gennemførelsesrate er, jo lavere bliver dit gebyr - fra Standard (20%) op til Platin (10,2%). Niveauet vises på din profil, så opgavestillere kan se det, når de vælger mellem forslag.",
      },
      {
        q: "Kan jeg fortryde, hvis jeg har fået tildelt en opgave, der viser sig at være større end forventet?",
        a: "Ja. Du kan trække dig fra en tildelt opgave, før den er markeret udført. Opgavestilleren får automatisk sit beløb refunderet, og opgaven bliver åben for nye forslag igen.",
      },
      {
      ...
      {
        q: "Kan jeg få besked automatisk, når en opgave matcher det, jeg kan?",
        a: "Ja. Under \"Profil\" kan du markere, hvilke kategorier du tager opgaver inden for. Så snart en ny opgave i en af dem bliver oprettet, får du en notifikation (og en email, hvis du har det slået til), og din profil bliver samtidig synlig i den offentlige konsulentoversigt.",
      },
    ],
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: "Ja. Betalingen håndteres af Stripe, som lever op til de højeste standarder for datasikkerhed (PCI DSS niveau 1). Dine kortoplysninger går aldrig gennem Konsulentbuds egne servere.",
      },
      {
