export const FAQ_SECTIONS = [
  {
    ...
    items: [
      ...
      {
        q: "Kan jeg finde en konsulent uden selv at oprette en opgave og vente på bud?",
        a: "Ja. Under \"Konsulenter\" kan du gennemse konsulenter, der har udfyldt en profil og markeret, hvilke kategorier de tager opgaver inden for - filtrér efter fagområde, og tag selv kontakt. Vil du hellere modtage flere bud og sammenligne, er det stadig hurtigst at oprette en opgave.",
      },
    ],
  },
  {
