...
ALTER TABLE tasks ADD COLUMN IF NOT EXISTS experience_level TEXT;
ALTER TABLE tasks ADD COLUMN IF NOT EXISTS engagement_type TEXT;
ALTER TABLE tasks ADD COLUMN IF NOT EXISTS scope TEXT;
ALTER TABLE tasks ADD COLUMN IF NOT EXISTS industry_knowledge TEXT;
...
-- Kategorier konsulenten selv har markeret, at de tager opgaver inden for
-- (kommasepareret liste af kategorinavne fra lib/categories.js). Bruges både
-- til den offentlige konsulentoversigt (/konsulenter) og til automatisk at
-- gøre opmærksom på nye opgaver, der matcher.
ALTER TABLE profiles ADD COLUMN IF NOT EXISTS categories TEXT;
-- Om profilen skal vises i konsulentoversigten og modtage matches på nye
-- opgaver. Slået til som standard, så en udfyldt profil er synlig med det
-- samme - kan slås fra i indstillinger.
ALTER TABLE profiles ADD COLUMN IF NOT EXISTS listed BOOLEAN NOT NULL DEFAULT true;
