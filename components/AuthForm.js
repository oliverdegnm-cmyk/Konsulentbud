...
export default function AuthForm({ title, subtitle }) {
  ...
  return (
    <div style={{ background: "#F3EEFC", borderRadius: 20, padding: 32, maxWidth: 420 }}>
      {mode !== "forgot" && (
      ...
      <h2 style={{ fontSize: 19, marginBottom: 6, fontWeight: 800 }}>
        {title || (mode === "login" ? "Log ind på Konsulentbud" : mode === "signup" ? "Opret en konto" : "Nulstil adgangskode")}
      </h2>
          ...
          {mode === "signup" && (
            <>
              <div style={{ marginTop: 6 }}>
                <div style={{ fontSize: 12.5, fontWeight: 700, color: "#5B6478", marginBottom: 8 }}>Hvad er dit mål med Konsulentbud?</div>
