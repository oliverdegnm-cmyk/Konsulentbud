  ...
  return (
    ...
    >
      <p style={{ fontSize: 12.5, lineHeight: 1.55, margin: 0, flex: "1 1 260px", color: "#D6DCEC" }}>
        {GA_ENABLED
          ? "Konsulentbud bruger én nødvendig cookie til at holde dig logget ind. Med dit samtykke bruger vi desuden Google Analytics til at måle besøg på siden."
          : "Konsulentbud bruger kun én nødvendig cookie til at holde dig logget ind - ingen sporing eller reklamer."}{" "}
        Læs mere i vores{" "}
